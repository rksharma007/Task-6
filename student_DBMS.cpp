/* CPP PROGRAM TO CREATE STUDENT DATABASE MANAGEMENT SYSTEM"*/
...
int main()
{
    // Considering the max length of name to be 20.
    char data[20];
    int n = 0, option = 0, count_n = 0;
    string empty = "00";
    string proctor = "";
    // Name of the file in which database is stored - 'data.txt'.
    ifstream f("data_file.txt");
    string line;

    // Here, for loop counts the total number of lines in the file.
    for (int i = 0; std::getline(f, line); ++i) {
        count_n++;
    }

    while (option != 6) {
        // This prints out all the available options in the database
        cout << "\nDBMS PROJECT: \n1. Add New "
                "Students"
             << "\n2. Student Login\n3. Faculty Login\n4. "
                "Proctor Login\n5. Admin View\n"
        ...
        if (option == 1) {
            ...
            for (int i = 0; i < n; i++) {
                ofstream outfile;
                outfile.open("data_file.txt", ios::app);
            ...
            ifstream infile;
            int check = 0;
            infile.open("data_file.txt", ios::in);
            ...
            while (infile >> data) {
                if (strcmp(data, regno) == 0) {
                    ...
                    infile >> data;
                    cout << "CSE101 mark: " << data
                         << endl;

                    infile >> data;
                    cout << "CSE102 mark: " << data
                         << endl;
        ...
        // This loop is used to view and add marks to the database of a student
            ...
            cin >> subcode;
            string code1 = "CSE101", code2 = "CSE102",
                   mark = "";
            ifstream infile;
            int check = 0;
        ...
        // This loop displays all the details of students under the same proctor ID.
            ...
            while (infile >> temp1) {
                ...
                if (strcmp(id, procid) == 0) {
                    ...
                    cout << "CSE101 Mark: " << temp3
                         << endl;
                    cout << "CSE102 Mark: " << temp4
                         << endl;
                    check = 1;
                }
            }
        ...
        // data in the file.
            ...
            // This value can be changed according to requirement of the administrator

            string admin_pass = "admin";

            if (strcmp(password, admin_pass.c_str()) == 0) {
                cout << "Reg No.       "
                        "\tName\tCSE101\tCSE102\tProctor "
                        "ID"
                     << endl;
                ifstream infile;
                infile.open("data_file.txt", ios::in);
